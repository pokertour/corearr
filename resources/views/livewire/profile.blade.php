...
new #[Layout('components.layouts.app')] #[Title('Profil & Sécurité')] class extends Component {
    public string $name = '';
    public string $email = '';
    ...
    public function updateProfile()
    {
        ...
        $this->dispatch('notify', title: 'Profil mis à jour', type: 'success');
    }
    ...
    public function updatePassword()
    {
        ...
        $this->dispatch('notify', title: 'Mot de passe modifié', type: 'success');
    }
    ...
    public function enableTwoFactor(EnableTwoFactorAuthentication $enable)
    {
        ...
        $this->dispatch('notify', title: '2FA Activé', type: 'success');
    }
    ...
    public function disableTwoFactor(DisableTwoFactorAuthentication $disable)
    {
        ...
        $this->dispatch('notify', title: '2FA Désactivé', type: 'warning');
    }
};
...
<div class="space-y-8">
    <div>
        <h2 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white">Profil & Sécurité</h2>
        <p class="text-sm text-zinc-500">Gérez vos informations et sécurisez l'accès au Command Center.</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-4">Informations du Profil</h3>
        <form wire:submit="updateProfile" class="space-y-4">
            <div>
                <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Nom d'affichage</label>
            ...
            <!-- Change Password -->
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
        <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-4">Modifier le mot de passe</h3>
        <form wire:submit="updatePassword" class="space-y-4">
            <div>
                <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Mot de passe actuel</label>
            ...
            <div>
                <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Nouveau mot de passe</label>
            ...
            <div>
                <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Confirmer le mot de passe</label>
        ...
        <div class="space-y-8">
            <!-- 2FA Management -->
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
        <h3 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100 mb-2">Authentification à deux facteurs (2FA)</h3>
        <p class="text-sm text-zinc-500 mb-6">Ajoutez une sécurité supplémentaire à votre compte en requérant un jeton unique lors de la connexion.</p>
        ...
        @else
            @if($showQrcode)
                ...
                <div class="mb-6">
                    <p class="text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">Codes de récupération :</p>
