...
@if ($isConfigured && !empty($stats))
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <!-- Total Requests -->
        <div
            class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4 shadow-sm flex items-center gap-4">
        ...
        <div
            ...
            <div>
                <p class="text-[10px] uppercase tracking-widest font-bold text-zinc-500">En attente</p>
                <p class="text-2xl font-black text-zinc-900 dark:text-white">{{ $stats['processing'] ?? 0 }}</p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                <p class="text-[10px] uppercase tracking-widest font-bold text-zinc-500">Terminés</p>
                <p class="text-2xl font-black text-zinc-900 dark:text-white">{{ $stats['completed'] ?? 0 }}</p>
            </div>
        </div>
    </div>
@endif
